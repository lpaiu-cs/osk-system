...
# 차단되어야 하는 개인 데이터(검토자가 지정한 케이스 포함)
...
check "30_Projects/LLM Second Brain.md"                allow
check "40_Decisions/2026-06-18-second-brain-architecture.md" allow
check "20_Concepts/Tokenizer.md"                       allow
check "10_MOC/Development MOC.md"                       allow
